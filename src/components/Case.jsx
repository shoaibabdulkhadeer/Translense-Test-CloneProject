    ...
    <h1 className='text-4xl font-bold mb-10'>Case study</h1>
     ...
     <div className='flex bg-green-800 text-white'>
        ...
        <div className='flex flex-col justify-center pl-10'>
            ...
            <button className='bg-white text-green-700 font-bold mb-10  w-48 hover:bg-slate-200'> Donate Now </button>
            </div>
         

            <p className='w-[800px]'>Planning and zoning are examples of mitigation actions, 
